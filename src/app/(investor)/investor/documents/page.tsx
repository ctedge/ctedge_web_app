...
import { DocumentDownload } from "@/app/(customer)/dashboard/documents/document-download";
...
export default async function InvestorDocumentsPage() {
  ...
  return (
    <>
      <PageHeader title="Documents" description="Agreements, receipts, and any other documents assigned to you." />
      {documents.length === 0 ? (
